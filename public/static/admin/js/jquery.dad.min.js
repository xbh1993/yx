    ...
    $.prototype.dad = function(opts) {
        ...
        $(this).each(function() {
            ...
            function update_position(e) {                
                ...
                console.log($(".layui-upload-img").eq(1).width());
                setvalue();
            }
            function dad_end() {
            ...
            function(e) {
                ...
                if (mouse.target == false && e.which == 1 && active == true) {
                    ...
                    var targ = e.target;  
                    //获取元素名称  
                    if ($(targ).parent().attr('class')=='deletebtn') {
                       $('.demo div').removeClass();
                       $('.demo div').removeAttr();
                       $(targ).parent().click();
                       return;                       
                    }
                    if ($(targ).attr('class')=='layui-upload-img') {
                        indexsign=$(".layui-upload-img").index($(targ));
                        var value=$(".layui-upload-img").eq(indexsign).attr('data-value');
                        $("textarea[id='photodescribe2']").html(value==undefined?'':value);
                        $("textarea[id='photodescribe2']").val(value==undefined?'':value);
                    }
